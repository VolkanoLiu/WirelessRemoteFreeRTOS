...
uint8_t ssd1306_Init(I2C_HandleTypeDef *hi2c)
{
    ...
    ssd1306_WriteString("WirelessRemote", &Font_7x10, White);
...
void ssd1306_fillRect(int x, int y, int w, int h, SSD1306_COLOR fillcolor)
{
  ...
  int i;
  for (i = 0; i < h; i++)
    ssd1306_drawFastHLineInternal(x, y + i, w, fillcolor);
}